...
class MapSampleState extends State<MapSample> {
  ...
  late CustomClusterManager _manager2;
  ...
  @override
  void initState() {
    _manager = CustomClusterManager<Place>(items, _updateMarkers,
        markerBuilder: _getMarkerBuilder(Colors.red));

    _manager2 = CustomClusterManager<Place>(items2, _updateMarkers2,
  ...
  Future<Marker> Function(CustomCluster<Place>) _getMarkerBuilder(Color color) =>
      (cluster) async {
        return Marker(
