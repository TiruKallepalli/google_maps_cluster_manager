...
class CustomCluster<T extends ClusterItem> {
  final LatLng location;
  final Iterable<T> items;

  CustomCluster(this.items, this.location);

  CustomCluster.fromItems(Iterable<T> items)
      : this.items = items,
  ...
  CustomCluster.fromClusters(CustomCluster<T> cluster1, CustomCluster<T> cluster2)
  ...
  bool operator ==(o) => o is CustomCluster && items == o.items;
